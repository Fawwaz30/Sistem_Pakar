                    ...
                    <div class="col-md-10">
                        <form action="{{ route('aturan.update', $aturan->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.1" class="form-control @error('cf_pakar') is-invalid @enderror" name="cf_pakar" id="cf_pakar" value="{{ old('cf_pakar', $aturan->cf_pakar) }}" required>
                                <div class="invalid-feedback">
                                    @error('cf_pakar')
                                        {{ $message }}
                                    @enderror
